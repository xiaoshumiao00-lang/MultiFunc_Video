...
def render_style_config(pixelle_video, key_prefix: str = "digital"):
    """Render style configuration section (middle column)
    
    Args:
        pixelle_video: PixelleVideo service instance
