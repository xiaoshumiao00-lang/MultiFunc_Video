...
from multifunc_video.utils.os_util import list_resource_files, get_root_path, get_data_path
from multifunc_video.utils.template_util import get_all_templates_with_info

router = APIRouter(prefix="/resources", tags=["Resources"])


@router.get("/workflows/tts", response_model=WorkflowListResponse)
async def list_tts_workflows(multifunc_video: MultiFuncVideoDep):
    """
...
async def list_media_workflows(multifunc_video: MultiFuncVideoDep):
    """
...
async def list_image_workflows(multifunc_video: MultiFuncVideoDep):
    """
