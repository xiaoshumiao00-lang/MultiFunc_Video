...
"""
MultiFunc_Video FastAPI Application
...
from api.dependencies import shutdown_multifunc_video
...
async def lifespan(app: FastAPI):
    ...
    """
    # Startup
    logger.info("🚀 Starting MultiFunc_Video API...")
    await task_manager.start()
    logger.info("✅ MultiFunc_Video API started successfully\n")
    
    yield
    
    # Shutdown
    logger.info("🛑 Shutting down MultiFunc_Video API...")
    await task_manager.stop()
    await shutdown_multifunc_video()
    logger.info("✅ MultiFunc_Video API shutdown complete")


# Create FastAPI app
app = FastAPI(
    title="MultiFunc_Video API",
    description="""
    ## MultiFunc_Video - AI Video Generation Platform API
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Start MultiFunc_Video API Server")
