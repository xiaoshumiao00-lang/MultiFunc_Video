...
This page will guide you through installing MultiFunc_Video.
...
1. Visit [GitHub Releases](https://github.com/AIDC-AI/MultiFunc_Video/releases/latest) to download the latest version
...
Your browser should automatically open `http://localhost:8501` and display the MultiFunc_Video web interface.
