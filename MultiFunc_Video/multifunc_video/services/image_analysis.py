...
class ImageAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await multifunc_video.image_analysis("path/to/image.jpg")
        
        # Use local ComfyUI
        description = await multifunc_video.image_analysis(
            "path/to/image.jpg",
            source="selfhost"
        )
        
        # List available workflows
        workflows = multifunc_video.image_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await multifunc_video.image_analysis("temp/06.JPG")
