...
from multifunc_video.models.storyboard import Storyboard, StoryboardFrame, StoryboardConfig


class FrameProcessor:
    """Frame processor"""
    
    def __init__(self, multifunc_video_core):
        """
        Initialize
        
        Args:
            multifunc_video_core: MultiFuncVideoCore instance
        """
        self.core = multifunc_video_core
    ...
    async def _step_generate_audio(
        ...
        from multifunc_video.utils.os_util import get_task_frame_path
