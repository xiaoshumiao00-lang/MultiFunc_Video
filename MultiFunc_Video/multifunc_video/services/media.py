...
from multifunc_video.models.media import MediaResult
...
class MediaService(ComfyBaseService):
    ...
    Usage:
        ...
        media = await multifunc_video.media(
            prompt="a cat",
            workflow="image_flux.json"
        )
        
        # List available workflows
        workflows = multifunc_video.media.list_workflows()
    """
    ...
    def _scan_workflows(self):
        ...
        """
        from multifunc_video.utils.os_util import list_resource_dirs, list_resource_files, get_resource_path
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            media = await multifunc_video.media(prompt="a beautiful cat")
            if media.is_image:
