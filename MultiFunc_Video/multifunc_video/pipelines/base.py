...
from multifunc_video.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, multifunc_video_core):
        ...
        Args:
            multifunc_video_core: MultiFuncVideoCore instance (provides access to all services)
        """
        self.core = multifunc_video_core
        
        # Quick access to services (convenience)
        self.llm = multifunc_video_core.llm
        self.tts = multifunc_video_core.tts
        self.media = multifunc_video_core.media
        self.video = multifunc_video_core.video
        
        # Backward compatibility alias
        self.image = multifunc_video_core.media
