...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    def __init__(self, core):
        ...
        Args:
            core: MultiFuncVideoCore instance
        """
        super().__init__(core)
    ...
    async def __call__(
        ...
        **kwargs
        ...
        """
        from multifunc_video.pipelines.linear import PipelineContext
    ...
    async def generate_content(self, context: PipelineContext) -> PipelineContext:
        ...
        """
        from multifunc_video.prompts.asset_script_generation import build_asset_script_prompt
