...
from multifunc_video.pipelines.base import BasePipeline
from multifunc_video.models.progress import ProgressEvent
from multifunc_video.models.storyboard import (
    Storyboard,
    StoryboardFrame,
    StoryboardConfig,
    ContentMetadata,
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        multifunc_video.pipelines["my_custom"] = CustomPipeline(multifunc_video)
    ...
    async def __call__(
        ...
        from multifunc_video.utils.os_util import (
        ...
        from multifunc_video.utils.template_util import resolve_template_path, get_template_type
        ...
        from multifunc_video.utils.content_generators import generate_title
        ...
        # from multifunc_video.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from multifunc_video.utils.content_generators import generate_image_prompts
...
# Use immediately
multifunc_video.pipelines["quick"] = QuickPipeline(multifunc_video)
result = await multifunc_video.generate_video(text=content, pipeline="quick")
"""
