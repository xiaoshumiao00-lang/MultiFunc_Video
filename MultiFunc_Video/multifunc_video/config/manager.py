...
from .schema import MultiFuncVideoConfig
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.config: MultiFuncVideoConfig = self._load()
        self._initialized = True
    
    def _load(self) -> MultiFuncVideoConfig:
        """Load configuration from file"""
        data = load_config_dict(str(self.config_path))
        config = MultiFuncVideoConfig(**data)
    ...
    def update(self, updates: dict):
        ...
        self.config = MultiFuncVideoConfig(**merged)
