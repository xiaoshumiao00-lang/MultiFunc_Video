...
Provides utilities for managing paths and files in MultiFunc_Video.
...
def get_multifunc_video_root_path() -> str:
    """
    Get MultiFunc_Video root path
    
    Uses MULTIFUNC_VIDEO_ROOT environment variable to determine project root.
    ...
    env_root = os.environ.get("MULTIFUNC_VIDEO_ROOT")
...
def ensure_multifunc_video_root_path() -> str:
    """
    Ensure MultiFunc_Video root path exists and return the path
    
    Returns:
        Root path as string
    """
    root_path = get_multifunc_video_root_path()
...
def get_root_path(*paths: str) -> str:
    """
    Get path relative to MultiFunc_Video root path
    ...
    """
    root_path = ensure_multifunc_video_root_path()
    if paths:
...
def get_temp_path(*paths: str) -> str:
    """
    Get path relative to MultiFunc_Video temp folder
...
def get_data_path(*paths: str) -> str:
    """
    Get path relative to MultiFunc_Video data folder
...
def get_output_path(*paths: str) -> str:
    """
    Get path relative to MultiFunc_Video output folder
