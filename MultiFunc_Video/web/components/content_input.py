    ...
    with st.container(border=True):
        ...
        if not batch_mode:
            ...
            if mode == "fixed":
                ...
                split_mode = cached_selectbox(
                    tr("split.mode_label"),
                    key="content_split_mode",
            ...
            if mode == "generate":
                n_scenes = cached_slider(
                    tr("video.frames"),
                    key="content_n_scenes",
                    min_value=3,
                    max_value=30,
                    value=5,
...
- ✅ {tr('batch.rule_3')}
            ...
            title_prefix = cached_text_input(
                tr("batch.title_prefix_label"),
                key="batch_title_prefix",
...
def render_bgm_section(key_prefix=""):
    ...
    with st.container(border=True):
        ...
        from multifunc_video.utils.os_util import list_resource_files
        ...
        if bgm_choice != tr("bgm.none"):
            if st.button(tr("bgm.preview"), key=f"{key_prefix}preview_bgm", use_container_width=True):
                from multifunc_video.utils.os_util import get_resource_path, resource_exists
                try:
...
def render_version_info():
    ...
    with st.container(border=True):
        ...
        github_url = "https://github.com/AIDC-AI/MultiFunc_Video"
        
        # Version and GitHub link in one line
        github_url = "https://github.com/AIDC-AI/MultiFunc_Video"
        badge_url = "https://img.shields.io/github/stars/AIDC-AI/MultiFunc_Video"
