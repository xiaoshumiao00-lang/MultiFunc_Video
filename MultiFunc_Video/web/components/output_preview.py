...
def render_output_preview(multifunc_video, video_params):
    ...
    if is_batch:
        ...
        render_batch_output(multifunc_video, video_params)
    else:
        # Single video generation mode (original logic)
        render_single_output(multifunc_video, video_params)


def render_single_output(multifunc_video, video_params):
    ...
    with st.container(border=True):
        ...
        if st.button(tr("btn.generate"), type="primary", use_container_width=True):
            ...
            try:
                ...
                result = run_async(multifunc_video.generate_video(**video_params))
...
def render_batch_output(multifunc_video, video_params):
    ...
    with st.container(border=True):
        ...
        if st.button(
            ...
            batch_result = batch_manager.execute_batch(
                multifunc_video=multifunc_video,
                topics=topics,
