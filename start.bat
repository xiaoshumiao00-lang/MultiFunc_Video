...
set "PYTHONPATH=%PROJECT_ROOT%Pixelle-Video"

:: Set PIXELLE_VIDEO_ROOT environment variable for reliable path resolution
set "PIXELLE_VIDEO_ROOT=%PROJECT_ROOT%Pixelle-Video"
...
"%PYTHON_HOME%\python.exe" -m streamlit run Pixelle-Video\web\app.py
